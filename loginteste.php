...
<head>
    ...
    <link rel="stylesheet" href="assets/css/loginteste.css">
</head>
<style>
  body{
...
<body>
    <form class="formulario" method="POST">
        <div class="formulario_left">
            ...
            <input class="form_input1" type="text" placeholder="DIGITE AQUI SEU TELEFONE" id="user_telefone" name= "telefone" required>
            <label class="form_label" for="user_pass">SENHA</label>
            <input class="form_input2" type="password" placeholder="DIGITE AQUI SUA SENHA" id="user_pass" name="senha" required>
